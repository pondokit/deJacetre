      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if (check_user_permissions(request(), "Users@index"))
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ route('roles.index') }}"><i class="fa fa-circle-o"></i>Role Menu</a></li>
              <li><a href="#"><i class="fa fa-circle-o"></i>Permission Menu</a></li>
              <li><a href="{{ route('users.index') }}"><i class="fa fa-circle-o"></i> <span>Users</span></a>
              </li>
            </ul>
          </li>
        @endif
